...
extern void ThreadTestNew(int), Copy(char *unixFile, char *nachosFile);
extern void ThreadTest(void);
extern void PingPong(int);
...
//----------------------------------------------------------------------
// void ThreadTestCommand(int argc, char** argv) {
//     int n = 2;  // Example value, you can modify this to test with different values

//     // Parse the argument if provided
//     if (argc > 1) {
//         n = atoi(argv[1]);  // Convert command line argument to integer
//     }
//     ThreadTest(n);  // Pass the argument to ThreadTest
// }
